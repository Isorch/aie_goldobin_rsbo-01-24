...
- вызывает функции из `eda_cli.core`:
  ...
  - `missing_table`,
  - `compute_quality_flags`;
- возвращает флаги как результат приминения функции `compute_quality_flags` на датасете, что `/quality`.
    ...
    "id_duplicates_info": [
      {
        ...
        "unique": 35,
        "non_null": 36,
        "duplicate_rate": 0.02777777777777779
      }
    ],
    "has_many_zero_values": false,
    "many_zero_columns": [],
    "quality_score": 0.5444444444444445
  },
  "dataset_shape": {
    "n_rows": 36,
    "n_cols": 14
